            ...
            <div class="header-left">
                <router-link to="/blackjack" class="link-back">
                    <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 16.18L8 0.820004C8 0.0931494 7.24623 -0.277135 6.79868 0.244006L0.203166 7.92398C-0.0677208 8.23941 -0.0677208 8.76055 0.203166 9.07611L6.79867 16.7561C7.24623 17.2771 8 16.9068 8 16.18Z" fill="rgba(255, 107, 0, 0.3)" />
                        <rect x="6" y="5" width="12" height="7" rx="1" fill="rgba(255, 107, 0, 0.3)" />
                    </svg>
                </router-link>
