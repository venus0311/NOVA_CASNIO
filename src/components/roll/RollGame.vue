...
<style scoped>
    ...
    .roll-game .spinner-selector::before {
        ...
        border-top: 14px solid rgba(255, 107, 0, 0.3);
    }
    ...
    .roll-game .spinner-selector::after {
        ...
        border-left: 7.5px solid transparent;
        border-right: 7.5px solid transparent;
        border-bottom: 14px solid rgba(255, 107, 0, 0.3);
    }
    ...
    .roll-game .spinner-inner::before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(90deg, rgba(42, 42, 42, 0.5) 0%, rgba(42, 42, 42, 0) 100%);
        z-index: 1;
    }
    ...
    .roll-game .spinner-inner::after {
        ...
        top: 0;
        right: 0;
        background: linear-gradient(90deg, rgba(42, 42, 42, 0) 0%, rgba(42, 42, 42, 0.5) 100%);
        z-index: 1;
    }
