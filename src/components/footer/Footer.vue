    ...
    <footer id="footer">
        <div class="footer-top">
            <div class="top-info">
                ...
                <div class="info-text">
                    NOVA-CASINO.com is the #1 Gaming Platform and offers the best experience & rewards to our users.
                    <span class="gradient-orange">Innovative Gaming Experience</span>
                </div>
            </div>
            <div class="top-links">
...
<style>
    ...
    footer#footer .top-info::after {
        ...
        top: 0;
        right: 0;
        background: linear-gradient(0deg, transparent 50%, var(--bg-secondary) 50%), linear-gradient(0deg, rgba(255, 107, 0, 0) 0%, rgba(255, 107, 0, 0.3) 50%, rgba(255, 107, 0, 0) 100%);
    ...
    @media only screen and (max-width: 950px) {
        ...
        footer#footer .top-info::after {
            ...
            top: 0;
            left: 0;
            border-top: 1px dotted rgba(255, 107, 0, 0.3);
        }
