...
<style scoped>
    ...
    .leaderboard-user-element:nth-child(2)::before {
        background: linear-gradient(180deg, rgba(255, 138, 0, 0) 0%, #FF8A00 100%);
    }

    .leaderboard-user-element:nth-child(3)::before {
        background: linear-gradient(180deg, rgba(255, 107, 0, 0.3) 0%, #FF6B00 100%);
    }
    ...
    .leaderboard-user-element .element-inner:hover {
        background: rgba(255, 255, 255, 0.02);
    }

    .leaderboard-user-element:nth-child(1) .element-inner {
        background: radial-gradient(163.2% 163.2% at 50% -31.45%, rgba(255, 107, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(255deg, rgba(255, 107, 0, 0.15) 0%, rgba(255, 138, 0, 0.15) 100%);
    }

    .leaderboard-user-element:nth-child(2) .element-inner {
        background: radial-gradient(163.2% 163.2% at 50% -31.45%, rgba(255, 138, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(255deg, rgba(255, 138, 0, 0.15) 0%, rgba(255, 107, 0, 0.15) 100%);
    }

    .leaderboard-user-element:nth-child(3) .element-inner {
        background: radial-gradient(163.2% 163.2% at 50% -31.45%, rgba(255, 107, 0, 0.15) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(255deg, rgba(255, 107, 0, 0.1) 0%, rgba(255, 138, 0, 0.1) 100%);
    }
