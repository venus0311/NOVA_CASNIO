...
<style scoped>
    ...
    .battles-game-element.element-group .type-inner span {
        background: linear-gradient(255deg, #FF6B00 0%, #FF8A00 100%);
    ...
    .battles-game-element .element-separator::before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, rgba(6, 36, 61, 0) 0%, #FF6B00 100%);
    ...
    .battles-game-element button.button-join:before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, rgba(255, 138, 0, 0) 0%, #FF6B00 100%);
        clip-path: polygon(6px 0, calc(100% - 6px) 0, 100% 25%, 100% 75%, calc(100% - 6px) 100%, 6px 100%, 0 75%, 0 25%);
    }

    .battles-game-element button.button-waiting:before {
        background: linear-gradient(180deg, rgba(255, 138, 0, 0) 0%, rgba(255, 107, 0, 0.2) 100%);
    }
    ...
    .battles-game-element .funding-inner span {
        font-size: 11px;
        font-weight: 800;
        background: linear-gradient(239deg, #FF6B00 -100%, #FF8A00 120%);
        background-clip: text;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
    }
    ...
    .battles-game-element button.button-waiting .button-inner {
        background: linear-gradient(255deg, rgba(255, 107, 0, 0.15) 0%, rgba(255, 138, 0, 0.15) 100%), #051f35;
    }
