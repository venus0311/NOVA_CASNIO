<template>
    <div class="duels-game-winner">
        <span style="color: var(--text-primary);">DUEL WINNER:</span>
            ...
            <div class="content-inner">
                ...
                <div class="inner-roll">
                    <div class="roll-inner">
                        <span style="color: var(--text-primary);">{{parseFloat(duelsGame.winner.roll / 100).toFixed(2)}}</span>
                    </div>
                </div>
            </div>
        </div>
...
<style scoped>
    ...
    .modal-duels-game .content-inner {
        ...
        padding: 0 25px;
        border-radius: var(--radius-md);
        background: radial-gradient(170% 170% at 50% 50%, rgba(255, 107, 0, 0.15) 0%, rgba(0, 0, 0, 0) 100%);
    ...
    .modal-duels-game .roll-inner {
        ...
        font-size: 14px;
        font-weight: 800;
        background: radial-gradient(130% 80% at 80% 50%, rgba(255, 107, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%);
        clip-path: polygon(4px 0, calc(100% - 4px) 0, 100% 25%, 100% 75%, calc(100% - 4px) 100%, 4px 100%, 0 75%, 0 25%);
    }
