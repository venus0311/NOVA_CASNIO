        ...
        <div class="games-my">
            <div class="my-header">
                <div class="header-title">
                    <span style="color: var(--text-primary);">MY GAMES</span>
                    ({{duelsGetGames.user.length}})
                </div>
                <button class="mobile-toggle" @click="toggleMyGames" v-if="isMobile">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4 6L8 10L12 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
            </div>
            <div class="my-content" v-bind:class="{ 'content-collapsed': isMobile && !myGamesExpanded }">
        ...
        <div class="games-all">
            <div class="all-header">
                ...
                <div class="header-actions">
                    <DuelsFilterSort />
                    <button class="mobile-toggle" @click="toggleAllGames" v-if="isMobile">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 6L8 10L12 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>
            ...
            <div class="all-content" v-bind:class="{ 'content-collapsed': isMobile && !allGamesExpanded }">
                <transition name="fade" mode="out-in">
                    <div v-if="socketDuels.connected === false" class="content-loading" key="loading">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                myGamesExpanded: true,
                allGamesExpanded: true,
                isMobile: false
            }
        },
        methods: {
            toggleMyGames() {
                this.myGamesExpanded = !this.myGamesExpanded;
            },
            toggleAllGames() {
                this.allGamesExpanded = !this.allGamesExpanded;
            },
            checkMobile() {
...
<style scoped>
    ...
    .duels-games .mobile-toggle:hover {
        background: rgba(255, 255, 255, 0.1);
    }

    .duels-games .mobile-toggle svg {
        transition: transform 0.3s ease;
    }

    .duels-games .content-collapsed {
        max-height: 0;
        overflow: hidden;
