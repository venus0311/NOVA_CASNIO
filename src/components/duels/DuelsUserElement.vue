            ...
            <div class="content-top">
                ...
                <div class="top-roll">
                    <div class="roll-inner">
                        ...
                        <span v-else style="color: var(--text-primary);">{{parseFloat(bet.roll / 100).toFixed(2)}}</span>
                    </div>
                </div>
            </div>
            <div class="content-bottom">
                <span v-if="duelsIsRolling === true" style="color: var(--text-primary);">ROLLING</span>
