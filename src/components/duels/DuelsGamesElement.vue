...
<style scoped>
    button.duels-games-element {
        ...
        margin-top: 20px;
        border-radius: 15px;
        background: radial-gradient(285% 150% at 50% 50%, #2a2a2a 0%, #1a1a1a 100%);
    ...
    button.duels-games-element.element-full .element-users::before {
        ...
        left: 0;
        border-radius: 15px;
        background: linear-gradient(180deg, #1a1a1a 0%, orange 100%);
        z-index: -1;
    }
    ...
    button.duels-games-element.element-full .users-inner {
        ...
        top: 1px;
        left: 1px;
        background: radial-gradient(140% 80% at 85% 50%, #1a1a1a 0%, #2a2a2a 100%), linear-gradient(255deg, rgba(0, 255, 194, 0.05) 0%, rgba(0, 170, 109, 0.05) 100%);
    }
