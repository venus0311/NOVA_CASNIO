...
<style scoped>
    ...
    a.blackjack-tables-element:hover .element-inner {
        background: radial-gradient(140% 80% at 85% 50%, rgba(255, 107, 0, 0.15) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(255deg, rgba(255, 107, 0, 0.05) -50%, rgba(255, 138, 0, 0.05) 100%);
    }
